...
const About = () => {
  ...
  return <section id="nosotros" className="py-20 font-corporate my-0 bg-slate-950">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 font-corporate text-slate-50">Sobre CARVIL Solutions Technology</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-20">
          <div className="space-y-6 animate-fade-in">
            <h3 className="text-3xl font-bold font-corporate text-slate-50">Nuestra Historia</h3>
          ...
          <div className="space-y-6 animate-fade-in">
            <h3 className="text-3xl font-corporate font-bold text-slate-50">Nuestra Misión</h3>
            <p className="text-gray-600 leading-relaxed font-corporate">
            ...
            <h3 className="text-2xl font-bold mt-8 font-corporate text-slate-50">Nuestra Visión</h3>
            <p className="text-gray-600 leading-relaxed font-corporate">
        ...
        {/* Valores */}
        <div className="mb-20">
          <h3 className="text-3xl font-bold text-center mb-12 font-corporate text-zinc-50">Nuestros Valores</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value, index) => <Card key={index} className="text-center hover:shadow-lg transition-all duration-300 group animate-fade-in">
                <CardContent className="p-6">
                  ...
                  <h4 className="text-xl font-bold mb-3 font-corporate text-gray-50">{value.title}</h4>
        ...
        {/* Equipo */}
        <div>
          <h3 className="text-3xl font-bold text-center mb-12 font-corporate text-zinc-50">Nuestro Equipo</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {team.map((member, index) => <Card key={index} className="text-center hover:shadow-lg transition-all duration-300 group animate-fade-in">
                <CardContent className="p-6">
                  ...
                  <h4 className="text-xl font-bold mb-1 font-corporate text-zinc-50">{member.name}</h4>
