      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in">
            ...
            <p className="text-xl text-carvil-steel-700 leading-relaxed text-zinc-950 font-corporate">Somos CARVIL Technology Solutions, tu socio estratégico en la transformación digital empresarial. Ofrecemos tecnología innovadora y adaptable para impulsar tu crecimiento.</p>
